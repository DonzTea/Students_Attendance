            ...
            <div class="col-lg-12 col-md-12 col-12 col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row w-100">
                            ...
                            <div class="col-10 text-right pr-0">
                                ...
                                <a href="{{ route('admin.teachers.show', 
                    ...
                    <div class="card-body">
                        ...
                        @else
                        <div>
                            <h4 class="text-center">Belum ada guru yang mengajar di {{$class->name}}</h4>
                        </div>
                        @endif
                    </div>
                </div>
...
<script>
    $(document).ready( function () {
            ...
            $('#datatables').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '{{route("admin.teachers.classData", $class->id)}}',
                    type: 'GET',
                },
                columns: [
