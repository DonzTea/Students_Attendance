...
@section('title')
Data Siswa {{$class->name}} Tahun Pelajaran {{$year->name}} - {{$year->name + 1}}
@endsection
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-12 col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        @if ($class->historyStudents()->count() > 0)
                        ...
                        @else
                        <div>
                            <h4 class="text-center">Tidak ada siswa di {{$class->name}} pada tahun pelajaran
...
<script>
    $(document).ready( function () {
        ...
        $('#datatables').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: '{{route("admin.historyStudents.schoolYearClassData", ["year_id" => $year->id, "class_id" => $class->id])}}',
                type: 'GET',
            },
            columns: [
