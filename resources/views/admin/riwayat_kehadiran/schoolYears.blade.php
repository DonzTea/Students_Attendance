...
<section class="section">
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item">Riwayat Kehadiran</div>
        </div>
    </div>
    ...
    <div class="section-body">
        <div class="card">
            ...
            <div class="card-body">
                ...
                if($school_year->historyPresence()->first() != null) {
                $anyHistory = true;
                }
                }
                @endphp
                ...
                <div class="row middle mt-3">
                    ...
                    <div class="col-12 col-md-4 col-lg-4">
                        <label>
                            ...
                            <a href="{{route('admin.historyPresences.index', $school_year->id)}}"
                ...
                <div>
                    <h4 class="text-center">
                        ...
                        <br />
                        riwayat kehadiran akan tercatat saat memasuki tahun pelajaran baru.
                    </h4>
                </div>
                @endif
            </div>
