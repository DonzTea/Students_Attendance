                    ...
                    <div class="row">
                        <div class="col-12 col-md-6 col-lg-6">
                            <div class="form-group">
                                ...
                                <select class="select2 w-100" name="region_id" data-width="100%">
                        ...
                        <div class="col-12 col-md-6 col-lg-6">
                            <div class="form-group">
                                ...
                                <input name="birthday" class="form-control datepicker" placeholder="Pilih Tanggal Lahir"
                                    value="{{$student->birthday ?: ''}}" autocomplete="off">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12 col-md-12 col-lg-12">
                            <div class="form-group">
                                ...
                                <input name="address" class="form-control"
                                    placeholder="contoh : Dusun Gendereh, Sumedang" value="{{$student->address ?: ''}}">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <select name="parent_id" class="select2 w-100" data-width="100%">
                                    ...
                                    <option value="{{$parent->id}}"
                                        {{$student->student_parent_id == $parent->id ? 'selected' : ''}}>
                                        {{$parent->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                                ...
                                <div class="custom-switches-stacked mt-2">
                                    ...
                                    <label class="custom-switch">
                                        <input type="radio" name="class_id" value="{{$class->id}}"
                                            ...
                                            {{$class->id == $student->class_group_id ? 'checked' : ''}}>
                                        <span class="custom-switch-indicator"></span>
                                        ...
                                        <div class="custom-switches-stacked mt-2">
                                            <label class="custom-switch">
                                                <input type="radio" name="live_with" value="Ayah Ibu"
                                                    class="custom-switch-input"
                                                    @if($student->family){{$student->family->live_with == 'Ayah Ibu' ? 'checked' : ''}}@endif>
                                                <span class="custom-switch-indicator"></span>
                                            ...
                                            <label class="custom-switch">
                                                <input type="radio" name="live_with" value="Ayah"
                                                    class="custom-switch-input"
                                                    @if($student->family){{$student->family->live_with == 'Ayah' ? 'checked' : ''}}@endif>
                                                <span class="custom-switch-indicator"></span>
                                            ...
                                            <label class="custom-switch">
                                                <input type="radio" name="live_with" value="Ibu"
                                                    class="custom-switch-input"
                                                    @if($student->family){{$student->family->live_with == 'Ibu' ? 'checked' : ''}}@endif>
                                                <span class="custom-switch-indicator"></span>
                                            ...
                                            <label class="custom-switch">
                                                <input type="radio" name="live_with" value="Orang Lain"
                                                    class="custom-switch-input"
                                                    @if($student->family){{$student->family->live_with == 'Orang Lain' ? 'checked' : ''}}@endif>
                                                <span class="custom-switch-indicator"></span>
                                        ...
                                        <div class="custom-switches-stacked mt-2">
                                            <label class="custom-switch">
                                                <input type="radio" name="economic_condition" value="Sangat Baik"
                                                    class="custom-switch-input"
                                                    @if($student->family){{$student->family->economic_condition == 'Sangat Baik' ? 'checked' : ''}}@endif>
                                                <span class="custom-switch-indicator"></span>
                                            ...
                                            <label class="custom-switch">
                                                <input type="radio" name="economic_condition" value="Baik"
                                                    class="custom-switch-input"
                                                    @if($student->family){{$student->family->economic_condition == 'Baik' ? 'checked' : ''}}@endif>
                                                <span class="custom-switch-indicator"></span>
                                            ...
                                            <label class="custom-switch">
                                                <input type="radio" name="economic_condition" value="Cukup Baik"
                                                    class="custom-switch-input"
                                                    @if($student->family){{$student->family->economic_condition == 'Cukup Baik' ? 'checked' : ''}}@endif>
                                                <span class="custom-switch-indicator"></span>
                                            ...
                                            <label class="custom-switch">
                                                <input type="radio" name="economic_condition" value="Kurang"
                                                    class="custom-switch-input"
                                                    @if($student->family){{$student->family->economic_condition == 'Kurang' ? 'checked' : ''}}@endif>
                                                <span class="custom-switch-indicator"></span>
                                        ...
                                        <div class="custom-switches-stacked mt-2">
                                            <label class="custom-switch">
                                                <input type="radio" name="learning_condition" value="Baik"
                                                    class="custom-switch-input"
                                                    @if($student->family){{$student->family->learning_condition == 'Baik' ? 'checked' : ''}}@endif>
                                                <span class="custom-switch-indicator"></span>
                                                <span class="custom-switch-description">Baik</span>
                                            </label>
                                            <label class="custom-switch">
                                                <input type="radio" name="learning_condition" value="Cukup"
                                                    class="custom-switch-input"
                                                    @if($student->family){{$student->family->learning_condition == 'Cukup' ? 'checked' : ''}}@endif>
                                                <span class="custom-switch-indicator"></span>
                                            ...
                                            <label class="custom-switch">
                                                <input type="radio" name="learning_condition" value="Kurang"
                                                    class="custom-switch-input"
                                                    @if($student->family){{$student->family->learning_condition == 'Kurang' ? 'checked' : ''}}@endif>
                                                <span class="custom-switch-indicator"></span>
                                                <span class="custom-switch-description">Kurang</span>
                                            </label>
                                        </div>
                        ...
                        <div class="col-12 col-md-6 col-lg-6">
                                ...
                                <div class="col-12 col-md-6 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input name="n_child" class="form-control" placeholder="contoh : 3"
                                            type="number" min="1" value="@if ($student->family){{
                                            $student->family->n_child != 0 ? $student->family->n_child : ''
                                            }}@endif">
                                    </div>
                                </div>
                                <div class="col-12 col-md-6 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input name="siblings_count" class="form-control" placeholder="contoh : 1"
                                            type="number" min="0" value="@if ($student->family){{
                                            $student->family->siblings_count != 0 ? $student->family->siblings_count : ''
                                            }}@endif">
                                    </div>
                                </div>
                                <div class="col-12 col-md-6 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input name="step_brothers_count" class="form-control" placeholder="contoh : 2"
                                            type="number" min="0" value="@if ($student->family){{
                                            $student->family->step_brothers_count != 0 ? $student->family->step_brothers_count : ''
                                            }}@endif">
                                    </div>
                                </div>
                                <div class="col-12 col-md-6 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input name="adopted_brothers_count" class="form-control"
                                            placeholder="contoh : 3" type="number" min="0" value="@if ($student->family){{
                                            $student->family->adopted_brothers_count != 0 ? $student->family->adopted_brothers_count : ''
                                            }}@endif">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input name="used_language" class="form-control" placeholder="contoh : Sunda"
                                    value="@if ($student->family){{$student->family->used_language}}@endif">
                            </div>
                        </div>
                    </div>
                </div>
