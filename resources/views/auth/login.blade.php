    ...
    <form method="POST" action="{{ route('login') }}">
      ...
      <div class="form-group">
        ...
        <input aria-describedby="emailHelpBlock" id="email" type="email"
          ...
          placeholder="Email terdaftar" tabindex="1" value="{{ old('email') }}" autofocus>
      ...
      <div class="form-group">
        ...
        <input aria-describedby="passwordHelpBlock" id="password" type="password" placeholder="Password akun anda"
