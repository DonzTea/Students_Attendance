...
return [
    ...
    */
    ...
    'attributes' => [
        'address' => 'alamat',
        'adopted_brothers_count' => 'jumlah saudara angkat',
        'age' => 'umur',
        'birthday' => 'tanggal lahir',
        'class_id' => 'kelas',
        'date' => 'tanggal',
        'economic_condition' => 'keadaan sosial ekonomi',
        'education_id' => 'pendidikan tertinggi',
        'gender' => 'jenis kelamin',
        'height' => 'tinggi badan',
        'homeroom_teacher_of' => 'wali kelas',
        'karpeg' => 'karpeg',
        'learning_condition' => 'situasi belajar di rumah',
        'live_with' => 'tinggal pada',
        'name' => 'nama',
        'n_child' => 'anak ke-',
        'nip' => 'nip',
        'nis' => 'nis',
        ...
        'region_id' => 'kota kelahiran',
        'religion_id' => 'agama',
        'siblings_count' => 'jumlah saudara kandung',
        'step_brothers_count' => 'jumlah saudara tiri',
        'student_id' => 'siswa',
        'teached' => 'kelas yang diajar',
        'type' => 'golongan',
        'used_language' => 'bahasa sehari-hari',
        'weight' => 'berat badan',
    ],
];
